APP        := agentchat
MODULE     := github.com/Renaissance-Mind/agent-in-chat-feishu
CMD        := ./cmd/agentchat
DIST       := dist
...
#
# By default all agents and the Feishu/Lark platform are included. To build with
# only specific agents, set AGENTS:
#
#   make build AGENTS=claudecode,codex
#
# You can also exclude specific agents:
#
#   make build EXCLUDE=gemini,cursor
# ---------------------------------------------------------------------------
