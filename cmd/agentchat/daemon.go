...
func printDaemonInstallResult(result *daemonInstallResult) {
	...
	fmt.Println("  agentchat daemon logs -f   - Follow logs")
	fmt.Println("  agentchat daemon restart   - Restart")
	fmt.Println("  agentchat daemon stop      - Stop")
	fmt.Println("  agentchat daemon uninstall - Remove")
}
...
func daemonUninstall() {
	...
	daemon.RemoveMeta()
	fmt.Println("agentchat daemon uninstalled.")
}
...
func daemonStart() {
	...
	fmt.Println("agentchat daemon started.")
}
...
func daemonStop() {
	...
	fmt.Println("agentchat daemon stopped.")
}
...
func daemonRestart() {
	...
	fmt.Println("agentchat daemon restarted.")
}
...
func requireInstalled(mgr daemon.Manager) {
	...
	if st == nil || !st.Installed {
		...
		fmt.Fprintln(os.Stderr, "  agentchat daemon install --work-dir /path/to/config-dir")
		os.Exit(1)
	}
}
...
func daemonStatus() {
	...
	fmt.Println("agentchat daemon status")
	fmt.Println()
	...
	if !st.Installed {
		...
		fmt.Printf("  Platform:  %s\n", st.Platform)
		fmt.Println()
		fmt.Println("  Run: agentchat daemon install")
		return
	}
...
func printDaemonUsage() {
	fmt.Println(`Usage: agentchat daemon <command> [flags]
