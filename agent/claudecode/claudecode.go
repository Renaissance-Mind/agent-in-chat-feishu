...
func New(opts map[string]any) (core.Agent, error) {
	...
	// the project-level config field by cmd/agentchat/main.go.
	spawnOpts := core.SpawnOptions{}
...
// run_as_user field (injected into opts by cmd/agentchat/main.go).
//
...
// supervisor-user spawn path — which is exactly the leak agentchat#496
