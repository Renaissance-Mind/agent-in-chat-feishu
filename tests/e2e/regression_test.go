...
// Package e2e contains smoke and regression tests for agentchat.
...
import (
	...
	"github.com/Renaissance-Mind/agent-in-chat-feishu/tests/mocks"
	"github.com/Renaissance-Mind/agent-in-chat-feishu/tests/mocks/fake"
...
func TestRegression_DiscordEmbed(t *testing.T) {
	...
	embed.Footer.Text = "agentchat v1.0"
	...
	assert.Equal(t, "agentchat v1.0", embed.Footer.Text)
