...
import (
	...
	"github.com/Renaissance-Mind/agent-in-chat-feishu/agent/claudecode"
	"github.com/Renaissance-Mind/agent-in-chat-feishu/agent/codex"
	"github.com/Renaissance-Mind/agent-in-chat-feishu/agent/cursor"
	"github.com/Renaissance-Mind/agent-in-chat-feishu/agent/gemini"
	"github.com/Renaissance-Mind/agent-in-chat-feishu/agent/opencode"
