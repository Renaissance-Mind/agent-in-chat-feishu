...
var messages = map[MsgKey]map[Language]string{
	...
	MsgUnknownCommand: {
		LangEnglish:            "`%s` is not a agentchat command, forwarding to agent...",
		LangChinese:            "`%s` 不是 agentchat 命令，已转发给 Agent 处理...",
		LangTraditionalChinese: "`%s` 不是 agentchat 命令，已轉發給 Agent 處理...",
		LangJapanese:           "`%s` は agentchat のコマンドではありません。エージェントに転送します...",
		LangSpanish:            "`%s` no es un comando de agentchat, reenviando al agente...",
	},
	MsgHelp: {
		LangEnglish: "📖 Available Commands\n\n" +
			...
			"/restart\n  Restart agentchat service\n\n" +
			"/status\n  Show system status\n\n" +
			"/version\n  Show agentchat version\n\n" +
		...
		LangSpanish: "📖 Comandos disponibles\n\n" +
			...
			"/restart\n  Reiniciar el servicio agentchat\n\n" +
			"/status\n  Mostrar estado del sistema\n\n" +
			"/version\n  Mostrar versión de agentchat\n\n" +
	...
	MsgHelpTitle: {
		LangEnglish:            "agentchat Help",
		LangChinese:            "agentchat 帮助",
		LangTraditionalChinese: "agentchat 說明",
		LangJapanese:           "agentchat ヘルプ",
		LangSpanish:            "agentchat Ayuda",
	},
	...
	MsgProviderListEmpty: {
		...
		LangJapanese:           "プロバイダが設定されていません。\n\n`config.toml` または `agentchat provider add` で追加してください。",
	...
	MsgStatusTitle: {
		...
		LangChinese: "agentchat 状态\n\n" +
			...
			"语言: %s\n" +
			"%s" + "%s" + "%s" + "%s" + "%s" + "%s",
		LangTraditionalChinese: "agentchat 狀態\n\n" +
			"項目: %s\n" +
			"Agent: %s\n" +
			"工作目錄: %s\n" +
			"平台: %s\n" +
		...
		LangJapanese: "agentchat ステータス\n\n" +
			...
			"言語: %s\n" +
			"%s" + "%s" + "%s" + "%s" + "%s" + "%s",
		LangSpanish: "Estado de agentchat\n\n" +
			"Proyecto: %s\n" +
			"Agente: %s\n" +
			"Directorio: %s\n" +
			"Plataformas: %s\n" +
	...
	MsgCardTitleStatus: {
		LangEnglish: "agentchat Status", LangChinese: "agentchat 状态", LangTraditionalChinese: "agentchat 狀態",
		LangJapanese: "agentchat ステータス", LangSpanish: "Estado de agentchat",
	},
	...
	MsgRestarting: {
		LangEnglish:            "🔄 Restarting agentchat...",
		LangChinese:            "🔄 正在重启 agentchat...",
		LangTraditionalChinese: "🔄 正在重啟 agentchat...",
		LangJapanese:           "🔄 agentchat を再起動中...",
		LangSpanish:            "🔄 Reiniciando agentchat...",
	},
	MsgRestartSuccess: {
		LangEnglish:            "✅ agentchat restarted successfully.",
		LangChinese:            "✅ agentchat 重启成功。",
		LangTraditionalChinese: "✅ agentchat 重啟成功。",
		LangJapanese:           "✅ agentchat の再起動が完了しました。",
		LangSpanish:            "✅ agentchat se reinició correctamente.",
	},
	MsgUpgradeChecking: {
	...
	MsgRelaySetupHint: {
		LangEnglish:            "\n\n⚠️ This agent does not auto-inject agentchat instructions.\nPlease run `/bind setup` or `/cron setup` to write instructions to %s.",
		LangChinese:            "\n\n⚠️ 当前 agent 不会自动注入 agentchat 指令。\n请运行 `/bind setup` 或 `/cron setup` 将指令写入 %s。",
		LangTraditionalChinese: "\n\n⚠️ 當前 agent 不會自動注入 agentchat 指令。\n請執行 `/bind setup` 或 `/cron setup` 將指令寫入 %s。",
		LangJapanese:           "\n\n⚠️ このエージェントは agentchat の指示を自動注入しません。\n`/bind setup` または `/cron setup` を実行して %s に指示を書き込んでください。",
		LangSpanish:            "\n\n⚠️ Este agente no inyecta automáticamente las instrucciones de agentchat.\nEjecute `/bind setup` o `/cron setup` para escribirlas en %s.",
	},
	MsgRelaySetupOK: {
		LangEnglish:            "✅ agentchat instructions written to %s\nThe agent can now use relay, cron, and attachment send-back.",
		LangChinese:            "✅ agentchat 指令已写入 %s\nagent 现在可以使用中继、定时任务和附件回传功能了。",
		LangTraditionalChinese: "✅ agentchat 指令已寫入 %s\nagent 現在可以使用中繼、定時任務和附件回傳功能了。",
		LangJapanese:           "✅ agentchat の指示を %s に書き込みました。\nエージェントがリレー、cron、添付ファイル返送を使えるようになりました。",
		LangSpanish:            "✅ Instrucciones de agentchat escritas en %s\nEl agente ahora puede usar relay, cron y reenvío de adjuntos.",
	},
	MsgRelaySetupExists: {
		LangEnglish:            "ℹ️ agentchat instructions already exist in %s — no changes made.",
		LangChinese:            "ℹ️ agentchat 指令已存在于 %s 中，无需重复写入。",
		LangTraditionalChinese: "ℹ️ agentchat 指令已存在於 %s 中，無需重複寫入。",
		LangJapanese:           "ℹ️ agentchat の指示は既に %s に存在します。変更はありません。",
		LangSpanish:            "ℹ️ Las instrucciones de agentchat ya existen en %s — sin cambios.",
	},
	...
	MsgSetupNative: {
		LangEnglish:            "✅ This agent natively supports agentchat instructions — no setup needed.",
		LangChinese:            "✅ 当前 agent 已原生支持 agentchat 指令，无需额外配置。",
		LangTraditionalChinese: "✅ 當前 agent 已原生支持 agentchat 指令，無需額外配置。",
		LangJapanese:           "✅ このエージェントは agentchat の指示をネイティブサポートしています。セットアップ不要です。",
		LangSpanish:            "✅ Este agente soporta nativamente las instrucciones de agentchat — no se necesita configuración.",
	},
	MsgCronSetupOK: {
		LangEnglish:            "✅ agentchat instructions written to %s\nThe agent can now use relay, cron, and attachment send-back.",
		LangChinese:            "✅ agentchat 指令已写入 %s\nagent 现在可以使用中继、定时任务和附件回传功能了。",
	...
	MsgBuiltinCmdRestart: {
		LangEnglish:            "Restart agentchat service",
		LangChinese:            "重启 agentchat 服务",
		LangTraditionalChinese: "重啟 agentchat 服務",
		LangJapanese:           "agentchat サービスを再起動",
		LangSpanish:            "Reiniciar el servicio agentchat",
	},
	MsgBuiltinCmdStatus: {
	...
	MsgBuiltinCmdVersion: {
		LangEnglish:            "Show agentchat version",
		LangChinese:            "查看 agentchat 版本",
		LangTraditionalChinese: "查看 agentchat 版本",
		LangJapanese:           "agentchat のバージョンを表示",
		LangSpanish:            "Mostrar versión de agentchat",
	},
	MsgBuiltinCmdHelp: {
